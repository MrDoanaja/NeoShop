 ...
 */
@import url("https://fonts.googleapis.com/css?family=Roboto+Condensed:300,400,700|Roboto+Slab:400,700&display=swap");
html {
  line-height: 1.15;
  /* 1 */
...
.shop {
  ...
  .shop__button {
    ...
    .shop__button:hover .shop__icon {
      color: var(--black); }
    .shop__button:hover .shop__text {
      opacity: 1;
      transform: none; }
  .shop__icon {
...
<div class="wrapper">
    <div class="slider">
        <ul>
            <li>
                <img src="./resources/slider/slide1.jpg" alt="Skate" title="Skate" />
            </li>
            <li>
                <img src="./resources/slider/slide2.jpg" alt="Consola" title="Consola" />
            </li>
             <li>
                <img src="./resources/slider/slide3.jpg" alt="Escalones" title="Escalones" />
            </li>
            <li>
                <img src="./resources/slider/slide4.jpg" alt="Suelo" title="Suelo" />
            </li>
        </ul>
        <!-- TODO: Desarrollar el marcado para el slider -->
    </div><!-- .slider -->
    <div class="products texto_centrado">
        <h1>PRODUCTOS</h1>
...
foreach($products as $obj){
        ...
        echo '<img class="mediana" src='.$img.' alt="'.$name.'" title="'.$name.'" />';
        echo '<p style="transform:  rotate(-15deg); background: yellow; width: 70px; ">'.$price.'</p>';
        echo '<h4>'.$name.'</h4>';
        echo '<a href="'.$button_link.'"class="load__button button" >COMPRAR</a>';
        echo '</div>';
}
        echo '</div>';
?>
